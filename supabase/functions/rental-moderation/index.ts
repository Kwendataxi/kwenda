...
serve(async (req) => {
  ...
  try {
    ...
    // Client avec anon key pour identifier l'utilisateur
    ...
    // Vérifier rôles via fonction SEC DEF public.get_user_roles
    ...
    const isAdmin = Array.isArray(roles) && roles.some((r: any) => r?.admin_role); // tout admin_role autorisé
