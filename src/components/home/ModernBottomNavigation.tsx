...
export const ModernBottomNavigation = ({ 
  ...
  return (
    ...
    >
      <div className="mx-4 mb-2 rounded-3xl bg-background/90 backdrop-blur-xl border-2 border-border/60 shadow-2xl overflow-hidden">
          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className="relative flex flex-col items-center gap-1 px-4 py-2 rounded-2xl transition-all duration-300 min-w-[68px] group active:scale-95"
              >
