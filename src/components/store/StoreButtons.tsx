  ...
  return (
    <div className={cn(
      ...
      <div className="relative">
        <div 
          className={cn(
            "flex items-center gap-2 bg-muted text-muted-foreground rounded-xl cursor-not-allowed opacity-60",
            sizeClasses[size]
          )}
        >
          ...
          {showLabels && (
            <div className="text-left">
              <div className="text-[10px] opacity-80 leading-tight">Bientôt sur</div>
              <div className="font-semibold leading-tight">App Store</div>
            </div>
          )}
        </div>
        <Badge className="absolute -top-1.5 -right-1.5 text-[9px] px-1.5 py-0.5 bg-orange-500 text-white border-0">
          Bientôt
        </Badge>
      </div>
    </div>
