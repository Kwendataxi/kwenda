      ...
      <DialogContent className="max-w-2xl max-h-[95vh] overflow-y-auto sm:max-w-2xl w-[95vw] sm:w-full">
        ...
        <Tabs defaultValue="overview" className="w-full">
          <TabsList className="grid w-full grid-cols-3">
            ...
            <TabsTrigger value="rewards">Niveaux</TabsTrigger>
          </TabsList>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              ...
              <CongoCard variant="warning" className="text-center">
                <CardContent className="pt-6 pb-4">
                  ...
                  <div className="text-2xl font-bold text-grey-900">{formatCurrency(stats.totalEarned)}</div>
          ...
          <TabsContent value="invite" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <DialogDescription>
                  Invitez vos amis et gagnez {formatCurrency(stats.currentReward)} par inscription réussie
                </DialogDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  <div className="flex items-center justify-center gap-4 p-4 bg-card border-2 border-dashed border-congo-green/40 rounded-lg">
                    <span className="text-2xl font-bold text-congo-green tracking-wider">
                      {loading ? '...' : referralCode}
                    </span>
                    <CongoButton
                      variant="success"
