            ...
            <div className="relative bg-gradient-to-br from-background via-background to-muted/20 rounded-3xl shadow-2xl border border-border/50 overflow-hidden">
              ...
              <div className="p-6 space-y-6 max-h-[60vh] overflow-y-auto">
                ...
                <motion.div
                  ...
                  className="wallet-glass p-4 rounded-2xl border border-border/30"
                >
                  <p className="text-xs text-muted-foreground mb-1">Solde disponible</p>
                  <p className="text-2xl font-bold text-foreground">
                    {wallet?.balance?.toLocaleString() || '0'} <span className="text-lg text-muted-foreground">CDF</span>
                  </p>
                </motion.div>
                ...
                <div>
                  ...
                  {loadingContacts ? (
                    <div className="grid grid-cols-3 gap-3">
                      {[1, 2, 3].map((i) => (
                        <div key={i} className="quick-transfer-loading h-24 rounded-xl bg-muted/30" />
                      ))}
                    </div>
                  ) : contacts.length === 0 ? (
