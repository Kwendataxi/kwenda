...
export const DriverCreditManager = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Info: Credits vs Earnings */}
      <div className="p-4 border rounded-lg bg-muted/30">
        <p className="text-sm text-muted-foreground">
          Les recharges de crédits servent aux frais/visibilité. Vos gains des courses sont versés dans votre portefeuille et sont distincts des recharges.
        </p>
      </div>
