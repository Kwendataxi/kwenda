...
export const PartnerRentalShareButtons: React.FC<PartnerRentalShareButtonsProps> = ({
  ...
  const partnerUrl = `${window.location.origin}/rental/partner/${partnerId}/shop`;

  const shareMessage = `🚗 Découvrez ${partnerName} sur Kwenda Location !
...
👉 ${partnerUrl}`;
  ...
  const handleEmailShare = () => {
    const subject = `🚗 Découvrez ${partnerName} sur Kwenda`;
