  ...
  const testimonials = [
    {
      ...
      content: "Kwenda Taxi a révolutionné mes déplacements ! Fini les négociations interminables avec les taxis. L'app est simple, les prix transparents et je peux payer avec mon Airtel Money.",
      rating: 5,
    ...
    },
    {
      ...
      content: "La tombola Kwenda, c'est génial ! J'ai déjà gagné 50 000 CDF le mois dernier. En plus des courses pratiques, on peut gagner de l'argent. Une vraie innovation !",
      rating: 5,
    ...
    },
    {
      ...
      content: "Avec Kwenda, j'envoie mes courses et mes documents en livraison express. Le suivi en temps réel me rassure totalement. Service impeccable et tarifs abordables !",
      rating: 5,
