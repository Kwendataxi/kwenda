...
export const ModernShoppingCart: React.FC<ModernShoppingCartProps> = ({
  ...
  const handleEscrowPayment = async () => {
    ...
    try {
      ...
      toast({
        title: 'Paiement sécurisé effectué',
        description: 'Vos fonds sont en escrow jusqu\'à la livraison',
      });
        ...
        <>
          ...
          <div className="border-t pt-6 space-y-4 bg-background">
            ...
            <p className="text-xs text-center text-muted-foreground">
              🔒 Vos fonds sont protégés jusqu'à la livraison • Livraison sous 24-48h
            </p>
          </div>
        </>
      )}
        ...
        <Card className="bg-gradient-to-br from-primary/10 to-accent/10 border-primary/30">
          <CardContent className="p-6 space-y-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold">Protection Escrow</h3>
                <p className="text-sm text-muted-foreground">Vos fonds sont sécurisés</p>
              </div>
            </div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center gap-2">
                ...
                <span>Paiement instantané depuis KwendaPay</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
                <span>Fonds libérés après livraison confirmée</span>
              </div>
              <div className="flex items-center gap-2">
                <CheckCircle className="w-4 h-4 text-green-500" />
          ...
          <CardContent className="p-4 space-y-3">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between text-xs text-muted-foreground">
                <span>Sera débité de votre KwendaPay</span>
  ...
  const renderProcessingView = () => (
    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
      ...
      <div>
        <h3 className="text-lg font-semibold mb-2">Traitement sécurisé</h3>
        <p className="text-muted-foreground">Configuration de l'escrow en cours...</p>
      </div>
    </div>
  );
    ...
    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground mb-4">
          Vos commandes ont été créées et vos fonds sont sécurisés en escrow
        </p>
        <div className="text-sm text-muted-foreground space-y-1">
          <p>• Les vendeurs ont été notifiés</p>
          <p>• Livraison sous 24-48h</p>
          <p>• Fonds libérés après livraison</p>
        </div>
      </div>
    </div>
  );
