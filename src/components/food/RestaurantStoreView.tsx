    ...
    <div className="min-h-screen bg-background pb-32">
      ...
      <div className="grid grid-cols-4 gap-2 px-4 mt-6">
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Card className="p-3 text-center bg-gradient-to-br from-orange-500/10 to-amber-500/10 border-orange-500/20">
            <Package className="w-5 h-5 text-orange-600 mx-auto mb-1" />
            <div className="text-lg font-bold text-orange-600">{stats.totalProducts}</div>
            <div className="text-xs text-muted-foreground">Plats</div>
          </Card>
        </motion.div>

        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Card className="p-3 text-center bg-gradient-to-br from-green-500/10 to-emerald-500/10 border-green-500/20">
            <ShoppingCart className="w-5 h-5 text-green-600 mx-auto mb-1" />
            <div className="text-lg font-bold text-green-600">{stats.totalOrders}</div>
        ...
        >
          <Card className="p-3 text-center bg-gradient-to-br from-yellow-500/10 to-amber-500/10 border-yellow-500/20">
            ...
            <div className="text-xs text-muted-foreground">{stats.ratingCount} avis</div>
          </Card>
        </motion.div>

        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Card className="p-3 text-center bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border-blue-500/20">
            <Users className="w-5 h-5 text-blue-600 mx-auto mb-1" />
            <div className="text-lg font-bold text-blue-600">{followersCount}</div>
      ...
      <AnimatePresence>
        {totalItems > 0 && (
          <motion.div
            ...
            className="mx-4 mt-6"
          >
            <Card className="p-4 bg-gradient-to-r from-primary/10 via-orange-500/10 to-amber-500/10 border-primary/20 relative overflow-hidden">
              <motion.div
              ...
              <div className="relative flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">dans votre panier</div>
                  </div>
                </div>
