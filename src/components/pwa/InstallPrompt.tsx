    ...
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Suivez ces étapes simples pour ajouter Kwenda à votre écran d'accueil
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      L'icône Kwenda apparaîtra sur votre écran d'accueil !
                    </p>
                  </div>
                </div>
              </CardContent>
              ...
              <CardContent className="pt-6 space-y-4">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Kwenda s'ouvrira dans sa propre fenêtre, comme une application native
                    </p>
                  </div>
                </div>
              </CardContent>
