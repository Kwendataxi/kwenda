    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="text-center space-y-6 mb-12">
          ...
          <h1 className="text-display-lg">Kwenda Taxi à Kinshasa</h1>
          <p className="text-body-lg text-muted-foreground max-w-3xl mx-auto">
            La capitale congolaise au cœur de notre innovation. Découvrez comment Kwenda Taxi 
        ...
        <Card className="bg-gradient-to-r from-primary/10 to-secondary/10">
          <CardContent className="p-8 text-center">
            <h2 className="text-heading-lg mb-4">Rejoignez la révolution Kwenda à Kinshasa !</h2>
