...
export class UniversalGeolocationService {
  ...
  private getFallbackPopularPlaces(city: CityConfig): any[] {
    const fallbacks: Record<string, any[]> = {
      ...
      abj: [
        { name: 'Plateau', commune: 'Plateau', lat: 5.3167, lng: -4.0167 },
        { name: 'Aéroport Félix Houphouët-Boigny', commune: 'Port-Bouët', lat: 5.2614, lng: -3.9262 },
        { name: 'Centre commercial Cap Sud', commune: 'Marcory', lat: 5.3024, lng: -3.9767 }
      ]
    };
