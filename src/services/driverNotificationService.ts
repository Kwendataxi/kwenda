...
class DriverNotificationService {
  ...
  private async checkPendingOrders(driverId: string): Promise<void> {
    console.log('🔍 [NotificationService] Polling check - Starting manual check for driver:', driverId);
    ...
    try {
      ...
      console.log('🔍 [NotificationService] Polling check - Found orders:', {
  ...
  private handleTransportNotification(payload: any): void {
    ...
    console.log('📡 [NotificationService] Transport notification received:', {
      orderId: order.id,
      status: order.status,
      biddingMode: order.bidding_mode,
